    ...
    IUpdateInstallResultService? installResultService = null) : IStartupUpdateService
{
        ...
        try
        {
            ...
            if (ShouldSkipRecentCheck(config.Updates, out var skipMessage))
            {
                return await SaveResultAsync(
                    ...
                    config.Updates.LastReleasePageUrl,
                    config.Updates.LastPackagePath,
                    config.Updates.LastPackageChecksumPath,
                ...
                && update.Status is UpdateCheckStatus.UpToDate or UpdateCheckStatus.NoRelease)
            {
                return await SaveResultAsync(
                    ...
                    update.ReleasePageUrl?.ToString(),
                    packagePath: null,
                    packageChecksumPath: null,
                    installScriptPath: null,
                    ...
                    StringComparison.OrdinalIgnoreCase))
            {
                return await SaveResultAsync(
                    ...
                    update.LatestVersion,
                    update.ReleasePageUrl?.ToString(),
                    packagePath: config.Updates.LastPackagePath,
                    packageChecksumPath: config.Updates.LastPackageChecksumPath,
                    installScriptPath: config.Updates.LastInstallScriptPath,
                    updateCheckedAt: true,
                    installLaunchedVersion: null,
                    cancellationToken).ConfigureAwait(false);
            }
            ...
            if (!config.Updates.InstallAutomatically)
            {
                return await SaveResultAsync(
                    ...
                    packageChecksumPath: download.ChecksumPath,
                    installScriptPath: null,
                    updateCheckedAt: true,
                    installLaunchedVersion: null,
                    cancellationToken).ConfigureAwait(false);
            ...
            return await SaveResultAsync(
                ...
                packageChecksumPath: download.ChecksumPath,
                installScriptPath: prepared.ScriptPath,
                updateCheckedAt: true,
        ...
        CancellationToken cancellationToken)
    {
        ...
        config.Updates.LastReleasePageUrl = releasePageUrl;
        config.Updates.LastPackagePath = packagePath;
        config.Updates.LastPackageChecksumPath = packageChecksumPath;
