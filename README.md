...
- Refresh settings include interval, notification enablement, history retention limits, a manual update check button, an explicit latest-update install action, startup update checks, and optional verified auto-download/auto-install launch policy.
