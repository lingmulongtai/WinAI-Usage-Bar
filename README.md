...
- Codex/ChatGPT app-server probing is isolated behind safe abstractions, and `--health-report` shows storage pressure guidance, recovery guidance, and the configured provider CLI override or resolved CLI launch target used for startup checks.
