...
- Diagnostics exports redact common secret shapes, account identifiers, scope/reference fields, and CLI override paths, use bounded redaction context for truncated large files, omit local app-data and secret-store root paths, and exclude `secrets/`.
